...
const SOCIALS = [
  { name: "Facebook", url: "https://facebook.com", Icon: FaFacebookF, handle: "@multiplikator.benin" },
  { name: "Instagram", url: "https://instagram.com", Icon: FaInstagram, handle: "@multiplikator_institut" },
  { name: "TikTok", url: "https://tiktok.com", Icon: FaTiktok, handle: "@multiplikator.bj" },
  { name: "YouTube", url: "https://youtube.com", Icon: FaYoutube, handle: "@MULTIPLIKATOR" },
  { name: "LinkedIn", url: "https://linkedin.com", Icon: FaLinkedinIn, handle: "MULTIPLIKATOR Institut de Langues" },
  { name: "Telegram", url: "https://t.me", Icon: FaTelegramPlane, handle: "@multiplikator" },
  { name: "WhatsApp", url: "https://wa.me/2290196593866", Icon: FaWhatsapp, handle: "+229 01 96 59 38 66" },
];
      ...
      <section className="max-w-[1400px] mx-auto px-5 lg:px-10 py-16 grid md:grid-cols-2 lg:grid-cols-3 gap-5">
        {SOCIALS.map((s, i) => (
          <a key={i} href={s.url} target="_blank" rel="noreferrer" data-testid={`social-${s.name}`} className="mpk-card p-7 group hover:border-[#580505] transition">
            <s.Icon className="text-[#580505]" size={30}/>
